package it.gravitymc.gravitykitpvp.utils.xseries;
...
public enum XSound {
    ...
    public static void stopMusic(Player player) {
        ...
        for (XSound music : musics) {
            ...
            if (sound != null) player.playSound(player.getLocation(), Sound.SPLASH2, 0, 0);
        }
    }
    ...
    public void stopSound(Player player) {
        ...
        if (sound != null) player.playSound(player.getLocation(), sound, 0, 0);
    }
    ...
    public static class SoundPlayer {
        ...
        public void play(Collection<Player> players, Location updatedLocation) {
    ...
    public static class Record implements Cloneable {
        ...
        public Record withSound(XSound sound) {
